...
<vaadin-vertical-layout style="width: 320px; height: 100%; align-items: center;">
 ...
 <vaadin-horizontal-layout theme="spacing-s" style="align-self: stretch; justify-content: space-between;">
  ...
  <vaadin-button tabindex="0" style=" background-color:   #f7b783 " id="ce">
    CE 
  </vaadin-button>
 ...
 <vaadin-horizontal-layout theme="spacing-s" style="align-self: stretch; justify-content: space-between;">
  ...
  <vaadin-button tabindex="0" style=" background-color:  #c0d2dc " id="pr">
    x 
  </vaadin-button>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout theme="spacing-s" style="align-self: stretch; justify-content: space-between;">
 ...
 <vaadin-horizontal-layout theme="spacing-s" style="align-self: stretch; justify-content: space-between;">
  ...
  <vaadin-button tabindex="0" style=" background-color: #dcc5c0 " id="egal">
    = 
  </vaadin-button>
  <vaadin-button tabindex="0" style=" background-color:  #c0d2dc " id="pls">
    + 
  </vaadin-button>
  <vaadin-button tabindex="0" style=" background-color:  #c0d2dc " id="mns">
    - 
  </vaadin-button>
 </vaadin-horizontal-layout>
 <vaadin-horizontal-layout theme="spacing-s" id="extendedLayout" style="align-self: stretch; justify-content: space-between;">
  ...
  <vaadin-button tabindex="0" id="cos">
    cos 
  </vaadin-button>
  <vaadin-button tabindex="0" id="sin">
    sin 
  </vaadin-button>
  <vaadin-button tabindex="0" id="tan">
    tan 
  </vaadin-button>
 </vaadin-horizontal-layout>
